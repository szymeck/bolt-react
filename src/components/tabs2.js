  ...
  return (
    <div className="container2">
      ...
      <div className="content-tabs">
        <div
          className={
            toggleState === 1 ? "box-content2  active-content" : "box-content2"
          }
        >
          <section>
            <div className="section-text">
              ...
              <p>
                Zeskanuj kod QR za pomocą aparatu telefonicznego, aby pobrać
        ...
        <div
          className={
            toggleState === 2 ? "box-content2  active-content" : "box-content2"
          }
        >
          <section>
            <div className="section-text">
      ...
      <div className="content-tabs2">
        <div
          className={
            toggleState === 1 ? "box-content3  active-content" : "box-content3"
          }
        >
          <section>
            <div className="section-img">
        ...
        <div
          className={
            toggleState === 2 ? "box-content3  active-content" : "box-content3"
          }
        >
          <section>
            <div className="section-img">
